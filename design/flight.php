<?php include 'header.php'; ?>
    ...
    <!-- Background Image Overlay -->
        ...
        <div class="absolute inset-0" style="background-image: url('https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3'); background-size: cover; background-position: center; opacity: 0.3;"></div>

        <!-- Hero Content (Text) -->
        <div class="hero-content">
            <h1 class="text-3xl md:text-5xl font-bold text-white mb-2 drop-shadow-lg">Find Your Perfect Stay</h1>
            <p class="text-base md:text-lg text-gray-100 drop-shadow">Search from over 2 million properties worldwide</p>
        </div>
    ...
    <div class="bg-white py-12 md:py-16 px-4 mt-10">
...
<div style="background-color: #F7F9FC; padding: 60px 20px;">
...
<div style="background-color: white; padding: 60px 20px;">
    <div style="max-width: 1200px; margin: 0 auto;">
