<style>
        ...
        <div class="form-container">
            ...
            <div class="tab-buttons">
                <button class="tab-btn active" data-tab="hotel">
                    <i class="fas fa-hotel"></i>
                    Hotels
                </button>
                <button class="tab-btn" data-tab="flight">
                    <i class="fas fa-plane"></i>
                    Flights
                </button>
                <a href="{{ route('visa.create') }}" class="tab-btn" style="text-decoration: none;">
            ...
            <!-- Hotel Form -->
            <div id="hotelForm" class="tab-content active p-3 sm:p-5">
            ...
            <!-- Flight Form -->
            <div id="flightForm" class="tab-content p-3 sm:p-5">
