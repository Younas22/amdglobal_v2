    ...
    <form id="flightSearchForm" onsubmit="return submitFlightForm(event)">
        <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-2 mb-2">
                <button type="button" id="roundTripBtn" class="trip-type-btn active">
                    <i class="fas fa-exchange-alt mr-2"></i>Round Trip
                </button>
                <button type="button" id="oneWayBtn" class="trip-type-btn">
                ...
                <div class="w-full sm:flex-1 bg-gray-50 rounded-lg p-2.5 border border-gray-200">
                    <div class="flex items-start gap-2">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="text" id="flightDepartureDate" class="w-full text-gray-900 font-semibold text-sm focus:outline-none cursor-pointer bg-transparent" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div id="returnDateField" class="w-full sm:flex-1 bg-gray-50 rounded-lg p-2.5 border border-gray-200">
                    <div class="flex items-start gap-2">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="text" id="flightReturnDate" class="w-full text-gray-900 font-semibold text-sm focus:outline-none cursor-pointer bg-transparent" readonly>
                        </div>
                    </div>
                </div>
